  ...
  return (
    <div className="min-h-screen bg-[#050507] text-zinc-100">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="mb-12">
          <h1 className="text-2xl font-bold mb-2">Условия использования</h1>
          <p className="text-sm text-zinc-600">Последнее обновление: Январь 2025</p>
        </div>

        <div className="border border-white/[0.04] bg-white/[0.01] rounded-xl p-5 mb-10">
          <p className="text-xs text-zinc-500 font-medium uppercase tracking-wider mb-3">Содержание</p>
        ...
        <div className="mt-16 pt-8 border-t border-white/[0.04] text-center">
          <p className="text-xs text-zinc-600 mb-4">Есть вопросы?</p>
