      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-[2] text-center px-6 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="https://discord.com/oauth2/authorize?client_id=1465945147207323742&permissions=8&integration_type=0&scope=bot+applications.commands" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto flex items-center justify-center gap-2 text-zinc-300 border border-indigo-500/20 bg-indigo-500/10 px-6 py-3.5 rounded-xl text-sm hover:bg-indigo-500/20 transition-all backdrop-blur-sm shadow-[0_0_15px_rgba(99,102,241,0.15)] group">
              <img width="20" height="20" src="https://img.icons8.com/color/48/discord-logo.png" alt="discord-logo" className="group-hover:scale-110 transition-transform" />
              Discord Бот
            </a>
